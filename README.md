...
#### 7.28
1. EECS183 diagnostic - Pay attention to the add(), the val can be a very large number. The standard way is to operate remainder and then plus the base number.
